...
public class OrderTest {
    ...
    public void shouldCalculateZeroIfOrderContainsNoProduct() {
        ...
        assertEquals(0.0, order.getPriceOfAvailableAndDeleteNotAvailableProducts(), DELTA);
    }
    ...
    public void shouldCalculateTwentyIfOrderContainsTwoAvailable10PriceProducts() {
        ...
        assertEquals(20.0, order.getPriceOfAvailableAndDeleteNotAvailableProducts(), DELTA);
    }
